# Modified ppo_continuous_action.py to plot expected return
...
if __name__ == "__main__":
    ...
    # Lists to store expected returns and steps for plotting
    expected_returns = []
    steps = []
    ...
    # Plotting the expected return over time
    plt.figure()
    plt.plot(steps, expected_returns, label='Expected Return')
    plt.xlabel('Steps')
    plt.ylabel('Expected Return')
    plt.legend()
    plt.title(f'Expected Return over Time: env={args.env_id}')
    plt.savefig(f"runs/{run_name}/expected_return_{args.env_id}.png")
    plt.show()
